...
from campus_job_agent.prompts.role_profile import (
    ...
    JOB_NORMALIZER_PROMPT_VERSION,
    OFFICIAL_JOB_EXTRACTOR_PROMPT_VERSION,
    ROLE_CLAIM_PROMPT_VERSION,
    ROLE_COVERAGE_PROMPT_VERSION,
    ROLE_QUERY_PROMPT_VERSION,
)

__all__ += [
    "ROLE_QUERY_PROMPT_VERSION", "JOB_NORMALIZER_PROMPT_VERSION",
    "EXPERIENCE_EXTRACTOR_PROMPT_VERSION", "OFFICIAL_JOB_EXTRACTOR_PROMPT_VERSION",
    "ROLE_CLAIM_PROMPT_VERSION", "ROLE_COVERAGE_PROMPT_VERSION",
]
