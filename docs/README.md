...
当前项目从 v0.3 起采用“统一证据层 + 候选人画像 + 求职意图 + 岗位需求画像 + 反馈闭环”的架构。v0.4 的设计文档已完成，等待依据文档实现候选人画像 subgraph。v0.1-v0.3 文档作为已完成版本的历史记录保留，后续变化通过新版本 requirements、RFC 和 ADR 描述。
...
当前 v0.4 已完成流程中的需求、RFC/ADR、任务拆解、contracts 和 eval 设计；下一步是 VSCode 实现、测试、生成 `v0.4-eval-report.md`，然后再将版本状态收口为 Implemented。
